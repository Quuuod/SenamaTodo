...
const todoModel_1 = __importDefault(require("./features/todos/model/todoModel"));
...
app.put('/api/todos/:id', async (req, res) => {
    ...
    const { text, completed } = req.body;
    try {
        const updatedTodo = await todoModel_1.default.findByIdAndUpdate(id, { text, completed }, { new: true });
        if (!updatedTodo) {
